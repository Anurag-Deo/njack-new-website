...
const ASSETS = {
  ...
  IMAGE: {
    ...
    NESCAFE:{
      src:"/Downloads/nescafe.jpg"
    },
    BUILDING:{
      src:"/Downloads/building.jpeg"
    }
  },
...
function genFixedMap() {
  // Define a fixed map with predefined sections
  let map = [
    {
      from: 0,
      to: 400,
      ...
      height: _ => 0,
      buildings: [
        { position: 100, type: 'building'},
        { position: 200, type: 'building' },
        { position: 300, type: 'nescafe' }
      ]
    },
    {
      from: 400,
      ...
      height: _ => 5,
      buildings: [
        { position: 500, type: 'building' },
        { position: 700, type: 'building' }
      ]
    },
    {
      from: 800,
    ...
    },
    {
      ...
      height: _ => -5,
      buildings: [
        { position: 1300, type: 'building' },
        { position: 1500, type: 'building' }
      ]
    },
    {
      from: 1300,
      ...
      height: _ => 0,
      buildings: [
        { position: 1700, type: 'building' },
        { position: 1900, type: 'building' }
      ]
    },
    {
      from: 1400,
    ...
    {
      from: 2800 // This indicates the end of the map
    }
  ];
...
function update(step) {
  ...
  for (let n = startPos; n < startPos + N; n++) {
    ...
    if((n % 10) === 0) {
      ...
      l.drawSprite(level, 0, ASSETS.IMAGE.TREE, -2)

    }
    if((n  % 10) === 0) l.drawSprite(level, 0, ASSETS.IMAGE.TREE, 1.3)
...
function reset() {
  ...
  start = timestamp()
  countDown = map[map.length - 2].to / 130 + 100
