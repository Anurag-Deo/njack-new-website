    ...
    <footer className={styles.footer}>
      <div className={styles.row}>
        <div className={styles.briefInfo}>
          ...
          <p>
            NJACK is the Computer Science Club at IIT Patna, dedicated to
            fostering a community of passionate computer science enthusiasts.
            NJACK serves as a nurturing platform for students passionate about
            computer science at IIT Patna.
          </p>
          <div className={styles.socialIcons}>
            ...
            <a
              target="_blank"
              referrerPolicy="no-referrer"
              href="https://twitter.com/njackiitp"
            >
